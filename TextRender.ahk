...
TextRenderDesktop(text:="", background_style:="", text_style:="") {
   ...
   return {base: TextRender.prototype}.__New("", WS_CHILD, WS_EX_LAYERED, hwndParent, x, y, w, h).Render(text, background_style, text_style)
}
...
TextRenderWallpaper(text:="", background_style:="", text_style:="") {
   ...
   return {base: TextRender.prototype}.__New("", WS_CHILD, WS_EX_LAYERED, WorkerW, x, y, w, h).Render(text, background_style, text_style)
}
